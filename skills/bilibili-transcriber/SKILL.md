...
description: 转录 B 站视频为文字。下载 B 站视频，提取音频，使用 Whisper 生成逐字稿。用户提到“B站转录”“bilibili-transcriber”“提取 B 站字幕/文稿”时使用。
...
```json
{
  "command": "python3 ~/.openclaw/workspace/skills/bilibili-transcriber/bili-transcribe.py \"$ARGUMENTS\" --task-mode",
  "description": "转录B站视频"
}
```
